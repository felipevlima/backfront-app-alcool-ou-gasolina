...
class HomeScreen: UIView {
    ...
    private func configContraints() {
        NSLayoutConstraint.activate([
            ...
            logoAppImage.topAnchor.constraint(equalTo: safeAreaLayoutGuide.topAnchor, constant: 104),
            logoAppImage.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 20),
            logoAppImage.trailingAnchor.constraint(equalTo: trailingAnchor, constant: -20),
